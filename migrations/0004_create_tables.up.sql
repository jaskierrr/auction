...
CREATE TABLE IF NOT EXISTS transactions (
    id BIGSERIAL PRIMARY KEY,
    sender_id BIGINT,
    sender_type VARCHAR(10) NOT NULL CHECK (sender_type IN ('User', 'Auction')),
    recipient_id BIGINT,
    ...
    FOREIGN KEY (sender_id) REFERENCES auctions(id) ON DELETE SET NULL,
    FOREIGN KEY (recipient_id) REFERENCES auctions(id) ON DELETE SET NULL
);
